...
export class Backend implements backendInterface {
    ...
    async markDelivered(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<OrderItem>, arg5: number, arg6: number, arg7: number, arg8: number, arg9: number, arg10: number): Promise<bigint> {
        if (this.processError) {
            try {
